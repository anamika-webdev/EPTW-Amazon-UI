      ...
      `}>
        <div className="flex items-center justify-between p-6 border-b">
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center h-20 shadow-lg w-58 bg-gradient-to-br from-orange-400 to-orange-400 rounded-xl">
              <span className="font-bold text-white text-3lg">Amazon EPTW</span>
            </div>
          </div>
          <button
            onClick={onMobileMenuClose}
