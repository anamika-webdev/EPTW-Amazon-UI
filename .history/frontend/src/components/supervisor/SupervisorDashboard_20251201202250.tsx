// frontend/src/components/supervisor/SupervisorDashboard.tsx - COMPLETE FIXED VERSION
...
export function SupervisorDashboard({ onNavigate }: SupervisorDashboardProps) {
  ...
  const initiatedPermits = allPermits.filter(p => 
