...
export function CreatePTW({ onBack }: CreatePTWProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    // ALL Requirements (shown regardless of category)
  ...
  const handleSubmit = async () => {
    try {
      ...
      const permitData = {
        ...
        receiver_name: 'Pending', // Will be assigned later
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <Select value={formData.site_id} onValueChange={(val) => setFormData({ ...formData, site_id: val })}>
                  <SelectTrigger>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setNewWorkerForm({ ...newWorkerForm, company_name: e.target.value })}
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setNewWorkerForm({ ...newWorkerForm, badge_id: e.target.value })}
                    ...
                    <div>
                      ...
                      <Select 
                        ...
                        onValueChange={(val) => setNewWorkerForm({ ...newWorkerForm, role: val })}
                      >
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
