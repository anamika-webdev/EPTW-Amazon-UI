...
### 1. **View Button** (All Tables)
- ✅ Calls `handleViewPermit(permit)` 
- ✅ Navigates to permit detail page
- ✅ Passes permit ID to detail view

### 2. **Extend Button** (In Progress Only)
- ✅ Prompts for new end time and reason
- ✅ Calls backend API to request extension
- ✅ Updates permit status to `Extension_Requested`
- ✅ Reloads dashboard after success

### 3. **Close Button** (In Progress Only)
- ✅ Confirms with user
- ✅ Asks closure checklist questions:
  - Housekeeping done?
  - Tools removed?
  - Locks removed?
  - Area restored?
  - Final remarks
- ✅ Calls backend API to close permit
- ✅ Updates status to `Closed`
- ✅ Reloads dashboard

### 4. **Special In Progress Table**
- ✅ Separate component with 3 action buttons
- ✅ Color-coded buttons:
  - View (default)
  - Extend (purple)
  - Close (red)
...
Make sure your `services/api.ts` has these methods:
...
Your backend should have these routes (likely already exist):
